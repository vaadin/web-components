...
Set the host's default role in `firstUpdated()` only if the application
...
[Common packages](common-packages.md).
...
properties come from the theme — see [Theming](theming.md).
