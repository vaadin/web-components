  ...
  ['ltr', 'rtl'].forEach((dir) => {
    ...
    describe(dir, () => {
      ...
      describe('long', () => {
        ...
        it('basic', async () => {
          contextmenu(element);
          await visualDiff(document.body, `${import.meta.url}_${dir}-long`);
        });
        ...
        it('bottom', async () => {
          ...
          contextmenu(element);
          await visualDiff(document.body, `${import.meta.url}_${dir}-long-bottom`);
        });
      });
      ...
      describe('items', () => {
        ...
        it('items', async () => {
          ...
          await visualDiff(document.body, `${import.meta.url}_${dir}-items`);
        });
      });
    });
  });
