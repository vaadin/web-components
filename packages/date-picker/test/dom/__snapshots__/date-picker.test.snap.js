...
`<vaadin-date-picker>
  <label
    for="input-vaadin-date-picker-0"
  ...
  <div
    hidden=""
    id="error-message-vaadin-date-picker-0"
    slot="error-message"
  >
  </div>
  <input
...
`<vaadin-date-picker has-helper="">
  ...
  <input
    aria-describedby="helper-vaadin-date-picker-0"
    aria-expanded="false"
    aria-haspopup="dialog"
    autocomplete="off"
    id="input-vaadin-date-picker-0"
  ...
  >
  <div
    id="helper-vaadin-date-picker-0"
    slot="helper"
  >
    Helper
  </div>
...
>
  ...
  <input
    aria-describedby="error-message-vaadin-date-picker-0"
    aria-expanded="false"
    aria-haspopup="dialog"
    aria-invalid="true"
    autocomplete="off"
