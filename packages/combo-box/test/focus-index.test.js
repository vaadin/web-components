...
describe('__focusIndex', () => {
  ...
  describe('items array', () => {
    ...
    it('should set the focused index to the given index', () => {
      comboBox.opened = true;
      comboBox.__focusIndex(100);
      expect(comboBox._highlightedItemIndex).to.equal(100);
    });
    ...
    it('should not shift the viewport when arrow-navigating among visible items', async () => {
      ...
      expect(comboBox._highlightedItemIndex).to.equal(101);
  ...
  describe('data provider', () => {
    ...
    it('should preserve focused index when both items at focusedIndex are placeholders', async () => {
      ...
      expect(comboBox._highlightedItemIndex).to.equal(lastIndex);
