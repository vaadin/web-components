  ...
  css`
    @layer vaadin.base {
      :where(html) {
        ...
        --_vaadin-icon-indent: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><g stroke-linecap="round" stroke-linejoin="round"><path d="M3.874 19.403h16.545M3.874 5.379h16.545M12.147 12.391h8.272M3.881 9.578v5.593l2.754-2.796-2.754-2.797"/></g></svg>');
        ...
        --_vaadin-icon-outdent: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2"><g stroke-linecap="round" stroke-linejoin="round"><path d="M3.874 19.403h16.545M3.874 5.379h16.545m-8.272 7.012h8.272M6.631 9.586v5.61l-2.757-2.805 2.757-2.805"/></g></svg>');
