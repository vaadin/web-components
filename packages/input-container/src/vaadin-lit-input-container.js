...
import { Stylable } from '@vaadin/vaadin-themable-mixin/stylable.js';
 ...
 */
export class InputContainer extends InputContainerMixin(Stylable(ThemableMixin(DirMixin(PolylitMixin(LitElement))))) {
  static get is() {
