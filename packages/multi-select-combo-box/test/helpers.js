...
/**
 * Returns the select all button of the combo-box, or null when it is not rendered.
 */
export const getSelectAllButton = (comboBox) => comboBox.querySelector('[slot="select-all"]');
