  ...
  class MultiSelectComboBoxMixinClass extends ComboBoxDataProviderMixin(
    ...
    __commitUserInput() {
      if (this._focusedIndex > -1) {
        ...
        if (this.allowCustomValue && !itemMatchingInputValue && !this._ignoreCommitValue) {
        ...
        } else if (!this.allowCustomValue && !this.opened && itemMatchingInputValue && !this._ignoreCommitValue) {
