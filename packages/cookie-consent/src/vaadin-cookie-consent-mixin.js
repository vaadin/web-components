...
export const CookieConsentMixin = (superClass) =>
  class CookieConsentMixinClass extends superClass {
    ...
    static get observers() {
      return ['__updatePopup(_showLearnMore, message, dismiss, learnMore, learnMoreLink, cookieName, position)'];
    }
    ...
    __updatePopup(_showLearnMore, message, dismiss, learnMore, learnMoreLink, cookieName, position) {
      this.__closePopup();
