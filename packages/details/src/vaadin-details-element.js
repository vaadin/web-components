...
import { ElementRegistryMixin } from './element-registry-mixin.js';
 ...
 * @mixes ElementMixin
 * @mixes ElementRegistryMixin
 * @mixes ThemableMixin
 */
class DetailsElement extends DetailsBaseMixin(
  ElementRegistryMixin(ElementMixin(ThemableMixin(ControllerMixin(PolymerElement)))),
) {
  static get template() {
    return html`
      <style>
