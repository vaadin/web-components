...
const DEFAULT_MESSAGE = 'The value of this field was generated with an AI.';
const DEFAULT_BADGE_LABEL = 'AI-provided value';
const DEFAULT_BADGE_TOOLTIP = 'Field value generated by AI. Click for more details';
...
describe('ai field marker', () => {
  ...
  describe('mark', () => {
    ...
    it('should render a badge tooltip', () => {
      const tooltip = marker.shadowRoot.querySelector('vaadin-tooltip');
      expect(tooltip.getAttribute('for')).to.equal('badge');
  ...
  describe('options', () => {
    it('should override message, revert text, badge tooltip and additional content', async () => {
      ...
      expect(marker.shadowRoot.querySelector('vaadin-tooltip').getAttribute('text')).to.equal('Open AI details');
  ...
  describe('setDefaults', () => {
    ...
    it('should apply globally configured texts to subsequently marked fields', async () => {
      ...
      expect(marker.shadowRoot.querySelector('vaadin-tooltip').getAttribute('text')).to.equal('Avaa tekoälyn tiedot');
    });
