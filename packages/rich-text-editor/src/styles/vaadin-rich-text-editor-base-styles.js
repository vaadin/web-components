...
export const content = css`
  ...
  */
  ...
  .ql-editor li > .ql-ui::before {
    ...
    margin-left: calc(var(--_item-indent) * -1);
    margin-right: var(--_marker-indent);
    text-align: right;
    white-space: nowrap;
  }
  ...
  .ql-editor li.ql-indent-1:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) + var(--_item-indent) * 2);
  }

  .ql-editor li.ql-indent-1.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) + var(--_item-indent) * 2);
  }

  /* indent 2 */
  .ql-editor li.ql-indent-2:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 2 + var(--_item-indent) * 3);
  }

  .ql-editor li.ql-indent-2.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 2 + var(--_item-indent) * 3);
  }

  /* indent 3 */
  .ql-editor li.ql-indent-3:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 3 + var(--_item-indent) * 4);
  }

  .ql-editor li.ql-indent-3.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 3 + var(--_item-indent) * 4);
  }

  /* indent 4 */
  .ql-editor li.ql-indent-4:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 4 + var(--_item-indent) * 5);
  }

  .ql-editor li.ql-indent-4.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 4 + var(--_item-indent) * 5);
  }

  /* indent 5 */
  .ql-editor li.ql-indent-5:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 5 + var(--_item-indent) * 6);
  }

  .ql-editor li.ql-indent-5.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 5 + var(--_item-indent) * 6);
  }

  /* indent 6 */
  .ql-editor li.ql-indent-6:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 6 + var(--_item-indent) * 7);
  }

  .ql-editor li.ql-indent-6.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 6 + var(--_item-indent) * 7);
  }

  /* indent 7 */
  .ql-editor li.ql-indent-7:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 7 + var(--_item-indent) * 8);
  }

  .ql-editor li.ql-indent-7.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 7 + var(--_item-indent) * 8);
  }

  /* indent 8 */
  .ql-editor li.ql-indent-8:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 8 + var(--_item-indent) * 9);
  }

  .ql-editor li.ql-indent-8.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 8 + var(--_item-indent) * 9);
  }

  /* indent 9 */
  .ql-editor li.ql-indent-9:not(.ql-direction-rtl) {
    padding-left: calc(var(--_list-indent) * 9 + var(--_item-indent) * 10);
  }

  .ql-editor li.ql-indent-9.ql-direction-rtl.ql-align-right {
    padding-right: calc(var(--_list-indent) * 9 + var(--_item-indent) * 10);
  }
  ...
  .ql-editor li.ql-direction-rtl > .ql-ui::before {
    margin-left: var(--_marker-indent);
    margin-right: calc(var(--_item-indent) * -1);
    text-align: left;
  }
  /* quill core end */
