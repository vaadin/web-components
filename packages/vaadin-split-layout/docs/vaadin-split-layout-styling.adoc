...
You can customize the handle by replacing the default content by your own implementation. You just have to mark your handle element with the class name `splitter-icon`.
