...
| image:../assets/png/megaphone.png[] | [propertyname]#megaphone# | megaphone | e6b4 | Social, Item | campaign, marketing
...
| image:../assets/png/palette.png[] | [propertyname]#palette# | palette | e667 | Tools, Item | color, paint
...
| image:../assets/png/bus.png[] | [propertyname]#bus# | bus | e90c | Transportation | vehicle, car, charter, coach
...
| image:../assets/png/trending-down.png[] | [propertyname]#trending-down# | trending-down | e960 | Charts | graph, diagram, line-chart, table, lower
