...
export const MonthPickerMixin = (superClass) =>
  class MonthPickerMixinClass extends I18nMixin(DEFAULT_I18N, InputMixin(superClass)) {
    ...
    checkValidity() {
      ...
      const inputValid =
        !inputValue || (!!selectedValue && inputValue === formatValue(this._parsedYearMonth, this.i18n));
    ...
    _onChange() {
      ...
      this._parsedYearMonth = parsedYearMonth;
    ...
    /** @private */
    __commitChanges(inputValue, selectedValue) {
    ...
    __ensureContent() {
      ...
      content.addEventListener('month-clicked', (e) => {
        this.opened = false;
        this._commitMonthClickedChanges(e.detail.value);
      });
