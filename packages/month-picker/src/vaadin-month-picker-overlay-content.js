 ...
 *
 * @customElement vaadin-month-picker-overlay-content
 * @extends HTMLElement
 * @mixes DirMixin
 * @mixes KeyboardMixin
 * @mixes ThemableMixin
...
class MonthPickerOverlayContent extends KeyboardMixin(
  ...
  __onMonthKeyDown(event) {
    ...
    // Flip ArrowLeft / ArrowRight in RTL so they always move in reading
    // order (matches the convention in `KeyboardDirectionMixin`).
    let key = event.key;
