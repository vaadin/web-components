...
The helpers are useful with custom data sources also since they provide out-of-the-box UI controls, visual feedback and hook to the data source callback parameters.
