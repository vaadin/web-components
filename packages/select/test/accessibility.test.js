...
describe('accessibility', () => {
  ...
  describe('focus', () => {
    ...
    describe('focus-ring', () => {
      ...
      it('should not set focus-ring attribute on outside click on subsequent opening after blur', async () => {
        select.setAttribute('focus-ring', '');
        select.opened = true;
        await oneEvent(overlay, 'vaadin-overlay-open');
        ...
        // Blur the select and then open it again without focus-ring
        select.blur();
        select.focus();
        select.opened = true;
        await oneEvent(overlay, 'vaadin-overlay-open');
