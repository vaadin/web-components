...
import { MenuBarButton } from './vaadin-menu-bar-button.js';
import { MenuBarItem } from './vaadin-menu-bar-item.js';
import { MenuBarListBox } from './vaadin-menu-bar-list-box.js';
import { MenuBarMixin } from './vaadin-menu-bar-mixin.js';
import { MenuBarOverlay } from './vaadin-menu-bar-overlay.js';
import { MenuBarSubmenu } from './vaadin-menu-bar-submenu.js';
...
class MenuBar extends MenuBarMixin(ElementMixin(ThemableMixin(PolymerElement))) {
  ...
  static register() {
    ...
    MenuBarButton.register();
    MenuBarItem.register();
    MenuBarListBox.register();
    MenuBarOverlay.register();
    MenuBarSubmenu.register();
