...
describe('date-time-picker', () => {
  ...
  describe('default', () => {
    describe('label aside', () => {
      ...
      it('baseline with helper above field', async () => {
        element.setAttribute('theme', 'label-aside helper-above-field');
        element.helperText = 'Helper text';
        div.appendChild(document.createElement('vaadin-date-picker'));
        await visualDiff(div, 'label-aside-baseline-helper-above-field');
      });
