...
- Paths to reference files: `packages/{component-name}/spec/web-component-spec.md` (with the specific sections to focus on), `packages/{component-name}/spec/web-component-api.md`, and the chapters of the `guidelines/` folder relevant to the agent's role.
