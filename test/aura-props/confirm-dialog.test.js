...
// TODO: --vaadin-confirm-dialog-min-width fails because the base styles wrap it in
// min(var(--vaadin-confirm-dialog-min-width, 15em), 100%) in vaadin-dialog-overlay-base-styles.js:39,
// so the computed min-width value includes the min() function rather than the raw value.
//
// TODO: --vaadin-confirm-dialog-max-width fails for the same reason as min-width — it is
// wrapped in min(var(--vaadin-confirm-dialog-max-width, 25em), 100%) in vaadin-dialog-overlay-base-styles.js:40.
//
...
describe('confirm-dialog', () => {
  let element;
  beforeEach(async () => {
    element = fixtureSync('<vaadin-confirm-dialog>Are you sure?</vaadin-confirm-dialog>');
